  ...
  return (
    <div>
      ...
      <div className="rounded-t-lg p-6 flex items-center gap-4 mb-6">
        ...
        />
        <div>
          <h2 className="font-bold text-2xl mb-1">{identity.name}</h2>
        ...
        <div className="space-y-4">
          <div>
            ...
            <div className="flex items-center">
              ...
              <span className="text-[14px]">{identity.idn_value}</span>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex items-center">
              ...
              <span className="text-[14px]">{identity.email}</span>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex items-center">
              ...
              <span className="text-[14px]">+373 {identity.phone}</span>
            </div>
          </div>
        </div>
      </div>
